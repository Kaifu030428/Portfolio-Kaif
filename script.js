...
> I am a Computer Science student passionate about software development and problem solving, with a strong interest in building impactful digital products.

> My primary focus is full stack web development using the MERN stack, alongside strengthening my Data Structures and Algorithms skills for software engineering roles.

> I enjoy creating scalable web applications, exploring modern technologies, and continuously improving as a developer through projects, practice, and real-world problem solving.
`;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateCarousel() {
    ...
    // Adjust offset dynamically based on window width
    const isMobile = window.innerWidth <= 768;
    const offset = isMobile ? 80 : 260; // tighter spacing on mobile
    ...
    cards.forEach((card, i) => {
      ...
      if (diff === 0) {
        ...
        card.style.transform = `translate(calc(-50% + ${offset}px), -50%) scale(0.9)`
        card.style.opacity = isMobile ? 0.2 : 0.6
        card.style.zIndex = 2
        card.style.pointerEvents = "auto"
  ...
  // Re-adjust heavily on window resize
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const experienceData = [
    { title: "MERN Stack", sub: "Full Stack Web Development" },
    { title: "DSA Practice", sub: "Problem Solving & Interview Prep" },
    { title: "Frontend Development", sub: "Modern UI/UX Implementation" },
    { title: "Backend Development", sub: "REST APIs & Server Logic" }
  ];
  
  const achievementData = [
    { title: "Hack On Hills", sub: "Participated in national hackathon at NIT Hamirpur" },
    { title: "Flowathon", sub: "Participated in app-building hackathon using FlutterFlow in Indore" },
    { title: "Rapid Prototyping", sub: "Built functional solutions under strict hackathon deadlines" },
    { title: "Team Collaboration", sub: "Worked in collaborative development environments during hackathons" }
  ];
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  btn.addEventListener("click", () => {
    ...
    const email = "kaif8763@gmail.com";
